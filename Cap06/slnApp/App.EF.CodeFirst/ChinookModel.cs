namespace App.EF.CodeFirst
{
    ...
    public partial class ChinookModel : DbContext
    {
        ...
        {
            Database.SetInitializer<ChinookModel>(null); /* deshabilitar validación */
            this.Configuration.LazyLoadingEnabled = false; /* deshabilitando la carga pesada (lazy loading) (información relacionada) a partir de la versión EF 4 se puede deshabilitar*/
